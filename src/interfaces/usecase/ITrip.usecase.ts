...
export interface ITripUsecase{
    ...
    getTripsbyFollowing(userid: string,page: number): Promise<ITrip[]>
    ...
    getTripsNearby(userid: string,userLocation: IUserLocation, maxDistance: number,page: number): Promise<ITrip[]>

...
class AuthUsecase {
    ...
    getAuth(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const auth = yield this.authRepository.emailAuth(email);
                return auth;
            }
            catch (error) {
                throw error;
    ...
    resetPassword(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Sending OTP
                const user = yield this.getAuth(email);
                if (!user)
    ...
    sendOtpByEmail(email, subject) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new Error(error.message || errorCodes_enum_1.ErrorCode.FAILED_SENDING_OTP);
            }
        });
    }
    userSignin(data) {
